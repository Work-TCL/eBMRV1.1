# Claude Code prompt — WP-12 / Document 89: Audit Trail, Record Version Vault & Data Integrity Validation

TASK:
Implement the Audit Trail, Record Version Vault & Data Integrity Validation module (SPEC-VAL-011) exactly as specified.

SOURCE OF TRUTH:
- `specs/Documents_01_105/Document_89_Audit_Vault_Data_Integrity_Validation_v1_0_IMPLEMENTATION_READY.md`
- Requirement IDs: DIV-FR-001..024 (24)
...
contracts/openapi/spec-val-011.yaml
contracts/events/spec-val-011/*.json
apps/ebmr_frappe/ebmr/…          # screens listed below (read-only projected GxP fields)
validation/requirements/spec-val-011/
```
...
|---|---|---|---|---|
| deriveDataIntegrityTestSuite() | Validation | data classes; risk; audit/Vault architecture | DataIntegritySuite | DataIntegritySuiteDerived |
| runAuditTamperDetectionTest() | Validation isolated env | audit scope; tamper scenario | TamperTestResult | AuditTamperTestCompleted |
| verifyVaultCanonicalization() | Automated validation | test vectors; engine version | CanonicalizationResult | VaultCanonicalizationVerified |
| verifyRecordCorrectionHistory() | Validation | record; correction scenario | IntegrityTestResult | RecordCorrectionHistoryVerified |
| verifyArchiveRetrievalIntegrity() | Validation/DR | archived record/evidence set | ArchiveIntegrityResult | ArchiveRetrievalVerified |
| approveDataIntegrityQualification() | QA/Validation | suite/results/deviations | DataIntegrityQualification | DataIntegrityQualificationApproved |
...
|---|---|---|
| `data_integrity_test_profile` | 5 | PostgreSQL (GxP Core, authoritative) |
| `tamper_test_execution` | 4 | PostgreSQL (GxP Core, authoritative) |
...
|---|---|---|
| `POST /validation/v1/data-integrity/suites` | yes | — |
| `POST /validation/v1/data-integrity/tamper-tests` | yes | — |
| `POST /validation/v1/data-integrity/{id}/approve` | yes | policy lookup (Doc 106) |
...
|---|---|---|
| `AuditTamperTestCompleted` | SPEC-VAL-011 | event_id |
| `VaultCanonicalizationVerified` | SPEC-VAL-011 | event_id |
| `ArchiveRetrievalVerified` | SPEC-VAL-011 | event_id |
| `DataIntegrityQualificationApproved` | SPEC-VAL-011 | event_id |
...
- Test case book: `test-cases/WP-12/Document_89_SPEC-VAL-011_TEST_CASES.md`
...
- Capture the evidence named in each case into `validation/evidence/<stage>/SPEC-VAL-011/<test_case_id>/`.
