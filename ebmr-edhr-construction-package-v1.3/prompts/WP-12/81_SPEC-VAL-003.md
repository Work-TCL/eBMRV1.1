# Claude Code prompt — WP-12 / Document 81: Requirements, Design Inputs & Validation Traceability Management

TASK:
Implement the Requirements, Design Inputs & Validation Traceability Management module (SPEC-VAL-003) exactly as specified.

SOURCE OF TRUTH:
- `specs/Documents_01_105/Document_81_Requirements_Design_Inputs_Validation_Traceability_v1_0_IMPLEMENTATION_READY.md`
- Requirement IDs: REQ-FR-001..023 (23)
...
contracts/openapi/spec-val-003.yaml
contracts/events/spec-val-003/*.json
apps/ebmr_frappe/ebmr/…          # screens listed below (read-only projected GxP fields)
validation/requirements/spec-val-003/
```

REQUIREMENTS TO IMPLEMENT (23):
...
|---|---|---|---|---|
| ingestRequirement() | Spec ingestion/Validation | source_doc; req_id; version; text; classification | RequirementVersion | RequirementIngested |
| linkRequirementToDesign() | Engineering/Extractor | requirement; function/API/schema/artifact ref | TraceLink | RequirementDesignLinked |
| linkRequirementToTest() | Validation | requirement; test/version; coverage type | TraceLink | RequirementTestLinked |
| freezeRequirementBaseline() | Validation Lead | release/scope; versions; exclusions | RequirementBaseline | RequirementBaselineFrozen |
| detectTraceabilityGaps() | Release gate | baseline; risk rules | TraceabilityGapReport | TraceabilityGapDetected |
| generateTraceabilityMatrix() | Validation/Inspection | baseline/release; format | TraceabilityMatrix | TraceabilityMatrixGenerated |
...
|---|---|---|
| `validation_requirement` | 6 | PostgreSQL (GxP Core, authoritative) |
| `trace_link` | 1 | PostgreSQL (GxP Core, authoritative) |
| `requirement_baseline` | 4 | PostgreSQL (GxP Core, authoritative) |
...
|---|---|---|
| `POST /validation/v1/requirements:ingest` | yes | — |
| `POST /validation/v1/trace-links` | yes | — |
| `POST /validation/v1/baselines` | yes | — |
| `GET /validation/v1/traceability` | no | — |
| `GET /validation/v1/traceability/gaps` | no | — |
...
|---|---|---|
| `RequirementIngested` | SPEC-VAL-003 | event_id |
| `RequirementBaselineFrozen` | SPEC-VAL-003 | event_id |
| `TraceabilityGapDetected` | SPEC-VAL-003 | event_id |
| `TraceabilityMatrixGenerated` | SPEC-VAL-003 | event_id |
...
- Test case book: `test-cases/WP-12/Document_81_SPEC-VAL-003_TEST_CASES.md`
...
- Capture the evidence named in each case into `validation/evidence/<stage>/SPEC-VAL-003/<test_case_id>/`.
