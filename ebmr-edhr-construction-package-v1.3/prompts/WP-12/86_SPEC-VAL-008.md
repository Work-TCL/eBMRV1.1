# Claude Code prompt — WP-12 / Document 86: Infrastructure, Cloud, Platform & Environment Qualification

TASK:
Implement the Infrastructure, Cloud, Platform & Environment Qualification module (SPEC-VAL-008) exactly as specified.

SOURCE OF TRUTH:
- `specs/Documents_01_105/Document_86_Infrastructure_Cloud_Platform_Environment_Qualification_v1_0_IMPLEMENTATION_READY.md`
- Requirement IDs: INFQ-FR-001..020 (20)
...
contracts/openapi/spec-val-008.yaml
contracts/events/spec-val-008/*.json
apps/ebmr_frappe/ebmr/…          # screens listed below (read-only projected GxP fields)
validation/requirements/spec-val-008/
```
...
|---|---|---|---|---|
| createInfrastructureQualificationProfile() | Platform/Validation | deployment profile; inventory; control requirements | InfraQualificationProfile | InfrastructureQualificationProfileCreated |
| captureInfrastructureFingerprint() | Qualification agent | environment | InfrastructureFingerprint | InfrastructureFingerprintCaptured |
| compareEnvironmentToQualifiedBaseline() | Validation | fingerprint; profile | InfrastructureComparison | InfrastructureQualificationDifferenceDetected |
| executeInfrastructureControlTest() | Validation/SRE | control/test code; environment | InfrastructureTestResult | InfrastructureControlTestCompleted |
| approveInfrastructureQualification() | Validation/QA | profile; tests; deviations; signature | QualifiedInfrastructure | InfrastructureQualified |
...
|---|---|---|
| `infrastructure_qualification_profile` | 5 | PostgreSQL (GxP Core, authoritative) |
| `infrastructure_fingerprint` | 4 | PostgreSQL (GxP Core, authoritative) |
...
|---|---|---|
| `POST /validation/v1/infrastructure/profiles` | yes | — |
| `POST /validation/v1/infrastructure/fingerprints` | yes | — |
| `POST /validation/v1/infrastructure/tests` | yes | — |
| `POST /validation/v1/infrastructure/{id}/approve` | yes | policy lookup (Doc 106) |
...
|---|---|---|
| `InfrastructureFingerprintCaptured` | SPEC-VAL-008 | event_id |
| `InfrastructureQualificationDifferenceDetected` | SPEC-VAL-008 | event_id |
| `InfrastructureQualified` | SPEC-VAL-008 | event_id |
...
- Test case book: `test-cases/WP-12/Document_86_SPEC-VAL-008_TEST_CASES.md`
...
- Capture the evidence named in each case into `validation/evidence/<stage>/SPEC-VAL-008/<test_case_id>/`.
