# WP-13 — Traceability & Build Status

## Test cases in this package

Index: `test-cases/WP-13/README.md`

| Document | Module | Risk | Test case book |
|---|---|---|---|
| 105 | SPEC-AI-001 | HIGHER-PROCESS-RISK | `test-cases/WP-13/Document_105_SPEC-AI-001_TEST_CASES.md` |

## Traceability view

`traceability/WP-13_TRACEABILITY.md` — one row per requirement showing module, risk, signature relevance,
