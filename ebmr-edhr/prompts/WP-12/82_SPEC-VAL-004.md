# Claude Code prompt — WP-12 / Document 82: Validation Test Strategy, Test Methods & Objective Evidence Governance

TASK:
Implement the Validation Test Strategy, Test Methods & Objective Evidence Governance module (SPEC-VAL-004) exactly as specified.

SOURCE OF TRUTH:
- `specs/Documents_01_105/Document_82_Validation_Test_Strategy_Methods_Objective_Evidence_v1_0_IMPLEMENTATION_READY.md`
- Requirement IDs: TST-FR-001..024 (24)
...
contracts/openapi/spec-val-004.yaml
contracts/events/spec-val-004/*.json
apps/ebmr_frappe/ebmr/…          # screens listed below (read-only projected GxP fields)
validation/requirements/spec-val-004/
```
...
|---|---|---|---|---|
| createValidationTestDefinition() | Validation/Engineer | test_type; requirements; risk; procedure/charter; expected results | TestDefinition | ValidationTestCreated |
| approveTestDefinition() | Reviewer | test/version; signature | ApprovedTest | ValidationTestApproved |
| startTestExecution() | Tester/CI | test version; environment fingerprint; data/config refs | TestExecution | ValidationTestExecutionStarted |
| recordTestObservation() | Tester/Automation | execution; step/check; actual; evidence; status | ObservationReceipt | ValidationObservationRecorded |
| completeTestExecution() | Tester/CI | execution; conclusion; summary | TestResult | ValidationTestCompleted |
| reviewTestExecution() | Reviewer | execution; conclusion; signature | TestReview | ValidationTestReviewed |
| importAutomatedTestEvidence() | CI | run ID; commit; report; artifact refs; fingerprint | ImportedTestEvidence | AutomatedEvidenceImported |
...
|---|---|---|
| `validation_test_definition` | 7 | PostgreSQL (GxP Core, authoritative) |
| `validation_test_execution` | 6 | PostgreSQL (GxP Core, authoritative) |
...
|---|---|---|
| `POST /validation/v1/tests` | yes | — |
| `POST /validation/v1/tests/{id}/approve` | yes | policy lookup (Doc 106) |
| `POST /validation/v1/executions` | yes | — |
| `POST /validation/v1/executions/{id}/complete` | yes | — |
| `POST /validation/v1/automated-evidence` | yes | — |
...
|---|---|---|
| `ValidationTestApproved` | SPEC-VAL-004 | event_id |
| `ValidationTestExecutionStarted` | SPEC-VAL-004 | event_id |
| `ValidationTestCompleted` | SPEC-VAL-004 | event_id |
| `AutomatedEvidenceImported` | SPEC-VAL-004 | event_id |
| `ValidationTestReviewed` | SPEC-VAL-004 | event_id |
...
- Test case book: `test-cases/WP-12/Document_82_SPEC-VAL-004_TEST_CASES.md`
...
- Capture the evidence named in each case into `validation/evidence/<stage>/SPEC-VAL-004/<test_case_id>/`.
