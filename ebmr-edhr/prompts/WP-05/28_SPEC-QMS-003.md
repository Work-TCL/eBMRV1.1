# Claude Code prompt — WP-05 / Document 28: Nonconformance Management

TASK:
Implement the Nonconformance Management module (SPEC-QMS-003) exactly as specified.

SOURCE OF TRUTH:
- `specs/Documents_01_105/Document_28_Nonconformance_Management_v1_0_IMPLEMENTATION_READY.md`
- Requirement IDs: NCR-FR-001..018 (18)
...
contracts/openapi/spec-qms-003.yaml
contracts/events/spec-qms-003/*.json
apps/ebmr_frappe/ebmr/…          # screens listed below (read-only projected GxP fields)
validation/requirements/spec-qms-003/
```
...
|---|---|---|
| `nonconformance_record` | 10 | PostgreSQL (GxP Core, authoritative) |
| `ncr_disposition` | 6 | PostgreSQL (GxP Core, authoritative) |
...
|---|---|---|
| `POST /qms/v1/nonconformances` | yes | — |
| `POST /qms/v1/nonconformances/{id}/segregate` | yes | — |
| `POST /qms/v1/nonconformances/{id}/evaluate` | yes | — |
| `POST /qms/v1/nonconformances/{id}/disposition` | yes | policy lookup (Doc 106) |
| `POST /qms/v1/nonconformances/{id}/verify` | yes | policy lookup (Doc 106) |
| `POST /qms/v1/nonconformances/{id}/close` | yes | policy lookup (Doc 106) |
...
|---|---|---|
| `NonconformanceOpened` | SPEC-QMS-003 | event_id |
| `NonconformingProductSegregated` | SPEC-QMS-003 | event_id |
| `NCRDispositionApproved` | SPEC-QMS-003 | event_id |
| `NCRReworkStarted` | SPEC-QMS-003 | event_id |
| `NCRReinspectionCompleted` | SPEC-QMS-003 | event_id |
| `NCRClosed` | SPEC-QMS-003 | event_id |
...
- Test case book: `test-cases/WP-05/Document_28_SPEC-QMS-003_TEST_CASES.md`
...
- Capture the evidence named in each case into `validation/evidence/<stage>/SPEC-QMS-003/<test_case_id>/`.
