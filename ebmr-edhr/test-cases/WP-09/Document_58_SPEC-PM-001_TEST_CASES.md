...
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** PostmarketSource registered (register_postmarket_source); PostmarketSourceRegistered audit/outbox event verified via a real pytest run (15/15 passed, services/gxp-api/tests/test_postmarket_flow.py).  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** SafetyCase created via createSafetyCaseLink() referencing source_record_type/id/version, never copying the source record.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** resolveMarketedProduct() sets marketed_product_id/product_resolution and transitions RECEIVED->IDENTITY_RESOLUTION.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** Unresolved identity remains identity_resolution_state=UNKNOWN_QUEUE (never discarded); ProductUnresolvedError raised if mark_resolved requested without identifiers.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** constituent_attribution accepted and stored on classifySafetyCase() against the CONSTITUENT_ATTRIBUTIONS enum.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** findProbableDuplicates() returns same-source-record-type/site candidates without a merge write.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** linkDuplicateCases() sets canonical_case_id on the duplicate; both rows verified to still exist afterward.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** addSafetyCaseFollowup() creates an immutable, sequentially-numbered follow-up and sets reassessment_required; a stale expected_version is rejected.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** classifySafetyCase() requires expectedness_reference whenever classification.expectedness is set.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** calculateSurveillanceMetric() computes a population/time-window-scoped numerator and freezes it as an immutable Vault snapshot; the same key reproduces the same snapshot.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** exposure_denominator explicitly marked denominator_uncertain=True when not supplied, never silently assumed.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** openSafetySignal() freezes a case/evidence snapshot at open time and rejects an unrecognized detection_source.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** assessSafetySignal() appends the prior assessment to assessment_history and advances state across TRIAGE->ASSESSMENT->CONFIRMED.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** Signal state machine DETECTED->TRIAGE->ASSESSMENT->CONFIRMED->ACTION/CLOSED enforced; DETECTED->CONFIRMED rejected.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** escalateSignalToQMSOrRegulatory() dispatches to the real qms CAPA/Field Action creation commands and stores the returned aggregate id.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** findProbableDuplicates() returns advisory candidates only; linkDuplicateCases() is the separate human decision.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** buildPeriodicSafetyDataset() freezes an immutable Vault dataset of qualifying cases in the interval; the same key reproduces the same snapshot.  |  **Defect:** none
...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** PASS  |  **Executed by:** Claude Code  |  **Date:** 2026-08-30  |  **Actual result:** get_postmarket_dashboard() reports open_cases/followup_backlog/unknown_identity_queue/open_signals counts.  |  **Defect:** none
