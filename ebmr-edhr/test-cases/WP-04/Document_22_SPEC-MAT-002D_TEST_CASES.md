...
- **Evidence to capture:** request/response, aggregate before/after, audit event id, outbox row, screenshot where UI-driven
- **Status:** BLOCKED  |  **Executed by:** claude-code  |  **Date:** 2026-08-25  |  **Actual result:** BLOCKED -- no ERP integration exists (WP-07 not built, same root cause as SG-077/082); get_material_reconciliation reports a fixed erp_posting_status of 'not_integrated' (SG-098).  |  **Defect:** SG-098
