...
stand-in for a real machine-identity model, SG-070/LIMS-FR-013 -- `lims_instance.py`'s own docstring
wrongly cites this as SG-067, an unrelated NCR gap; SG-070 is the correct number) onto `ErpInstance`
(migration 0103,
